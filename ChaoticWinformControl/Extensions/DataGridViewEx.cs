...
namespace ChaoticWinformControl.Extensions
{
    public static class DataGridViewExtension
    {
        ...
        /// <param name="doSomeAfterShowMenu">在显示菜单之前做点什么, 参数1: 行对应数据, 参数2: 列Index, 参数3: 行Index</param>
        ...
        public static void SetRightButtonMenu<TRowDate>(
            ...
            Action<TRowDate, int, int> doSomeAfterShowMenu, bool onlySelectOneRow = true,
            ...
            dgv.CellMouseDown += (sender, e) =>
            {
                if (e.Button == MouseButtons.Right)
                {
                    ...
                    {// 单元格区域
                        ...
                        {
                            doSomeAfterShowMenu?.Invoke(data, e.ColumnIndex, e.ColumnIndex);
