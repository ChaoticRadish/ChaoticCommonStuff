...
{
    public partial class ListComboBox : ComboBox
    {
        public ListComboBox()
        {
            InitializeComponent();
        ...
        /// <returns></returns>
        public ListComboBox SetSelectItemsFunc(Func<List<ItemData>> func)
        {
        ...
        /// <param name="func"></param>
        /// <returns></returns>
        public ListComboBox SetSelectItemsFunc(Func<List<KeyValuePair<object, string>>> func)
        {
        ...
        /// <returns></returns>
        public ListComboBox SetSelectItems(List<ItemData> items)
        {
            SelectItems = items;
            return this;
        }
        ...
        /// <param name="items">可选项列表</param>
        /// <returns></returns>
        public ListComboBox SetSelectItems(List<KeyValuePair<object, string>> items)
        {
