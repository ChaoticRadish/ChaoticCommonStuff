    ...
    public class ConfigurationManagerReadWriteImpl : IConfigReadWriteImpl
    {
        ...
        public T GetConfig<T>() where T : new()
        {
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                object obj = Util.String.StringConverter.Convert(value, property.PropertyType);
        ...
        public void SaveConfig<T>(T config) where T : new()
        {
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                string key;
                string value = ConfigHelper.Obj2ConfigValue(property.GetValue(config));
#if DEBUG
