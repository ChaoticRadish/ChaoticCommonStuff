...
namespace Util
{
    public static class ColorHelper
    {
        ...
        {
            Util.InputRevision.ToRange(ref r, 0, 255);
            Util.InputRevision.ToRange(ref g, 0, 255);
            Util.InputRevision.ToRange(ref b, 0, 255);
            Util.InputRevision.ToRange(ref a, 0, 255);
        ...
        public static HSVColor RgbToHsv(System.Drawing.Color color)
        {
            ...
            float CMax = InputRevision.Max(R, G, B);
            float CMin = InputRevision.Min(R, G, B);
