...
namespace Util
{
    public static class EnumHelper
    {
        ...
        [AttributeUsage(AttributeTargets.Field)]
        public class OtherNameAttribute : System.Attribute
        {
            public OtherNameAttribute(string name)
            {
                Name = name;
            }
        ...
        /// <param name="enumObj"></param>
        /// <returns></returns>
        public static string OtherName(this Enum enumObj)
        {
            return GetOtherName(enumObj, enumObj.GetType());
        }
        ...
        public static string GetOtherName(object enumObj, Type type)
        {
            if (!type.IsEnum) return null;
            string enumName = Enum.GetName(type, enumObj);
            FieldInfo field = type.GetField(enumName);
